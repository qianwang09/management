    ...
    <div class="table">
        <div class="container">
            ...
            <el-table :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="Parent" label="Process" sortable min-width="120"> </el-table-column>
        ...
        <el-dialog title="Add" :visible.sync="addVisible" width="40%">
            <el-form ref="addForm" :model="addForm" label-width="100px">
              <el-form-item label="Process">
                    <el-select v-model="addForm.Parent" placeholder="Select Process" class="handle-select mr10">
        ...
        <el-dialog title="Edit" :visible.sync="editVisible" width="40%">
            <el-form ref="editForm" :model="editForm" label-width="100px">
              <el-form-item label="Process">
                    <el-select v-model="editForm.Parent" placeholder="Select Process" class="handle-select mr10">
                        <el-option v-for="item in allParent" :key="item.Name" :label="item.Name" :value="item.Name"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="Name">
...
export default {
  data() {
    return {
      ...
      Url: "api/ProcessSubTypes",
      UrlParent: "api/ProcessTypes?status=Active",
      tableData: [],
      multipleSelection: [],
      allParent: [],
      addVisible: false,
