    ...
    <div class="table">
        ...
        <el-dialog title="Add" :visible.sync="addVisible" width="40%">
            <el-form ref="addForm" :model="addForm" label-width="100px">
              <el-form-item label="Function">
                    <el-select v-model="addForm.Parent" placeholder="Select Function" class="handle-select mr10">
        ...
        <el-dialog title="Edit" :visible.sync="editVisible" width="40%">
            <el-form ref="editForm" :model="editForm" label-width="100px">
              <el-form-item label="Function">
                    <el-select v-model="editForm.Parent" placeholder="Select Function" class="handle-select mr10">
                        <el-option v-for="item in allParent" :key="item.Name" :label="item.Name" :value="item.Name"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="Name">
...
export default {
  data() {
    return {
      ...
      Url: "api/ProcessCategories",
      UrlParent: "api/ProcessFunctions?status=Active",
      tableData: [],
      multipleSelection: [],
      allParent: [],
      addVisible: false,
