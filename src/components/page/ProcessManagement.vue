    ...
    <div class="table">
        <div class="container">
            ...
            <el-table :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="ProcessTypeId" label="ProcessType" sortable width="150">
                </el-table-column>
                <el-table-column prop="OperationCategoryId" label="OperationCategory" sortable width="100">
                </el-table-column>    
                <el-table-column prop="ManagerId" label="Approver" sortable width="100">
                </el-table-column>          
        ...
        <el-dialog title="Add" :visible.sync="addVisible" width="40%">
            <el-form ref="addForm" :model="addForm" label-width="100px">
                ...
                <el-form-item label="CostCenter">
                    <el-input v-model="addForm.CostCenter"></el-input>
                </el-form-item>
